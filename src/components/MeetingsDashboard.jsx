...
// Prefer env override. For local, change to your actual backend URL/port.
const API_BASE_URL =
  process.env.REACT_APP_API_BASE_URL ||
  (process.env.NODE_ENV === "development"
    ? "https://localhost:7141" // or "http://localhost:5194"
    : "https://teamsbackendapi-production.up.railway.app");
...
const calculateStats = (meetings) => {
  ...
  const totalPossibleMinutes = 8 * 60;
...
const MeetingsDashboard = () => {
  ...
  const meetingsByFloor = floorHeaders.reduce((acc, floor) => {
    acc[floor] = meetings.filter((m) => m.location?.toLowerCase().includes(floor.toLowerCase()));
    return acc;
  }, {});
  ...
  return (
    <div className="container-fluid px-2 px-md-3 px-lg-4 px-xl-5 my-3 my-md-4">
      ...
      <div
        ...
        style={{ background: "#2c3e50", color: "#fff", borderRadius: "12px" }}
      >
      ...
      <div className="row mb-3 mb-md-4">
        <div className="col-12">
          <div
            ...
            style={{ background: "rgba(255,255,255,0.8)", border: "1px solid #e0e0e0" }}
          >
            ...
            <div className="row text-center">
              <div className="col-6 col-md-3 mb-2 mb-md-3">
                <div className="p-2 p-md-3 rounded" style={{ background: "rgba(240, 248, 255, 0.7)" }}>
                  ...
                  <small className="text-muted d-none d-md-block">{stats.activeMeetings} currently active</small>
                  <small className="text-muted d-md-none">{stats.activeMeetings} active</small>
                </div>
              </div>
              ...
              <div className="col-6 col-md-3 mb-2 mb-md-3">
                <div className="p-2 p-md-3 rounded" style={{ background: "rgba(240, 248, 255, 0.7)" }}>
                  ...
                  <small className="text-muted d-none d-md-block">Across all meetings</small>
                </div>
              </div>
              ...
              <div className="col-6 col-md-3 mb-2 mb-md-3">
                <div className="p-2 p-md-3 rounded" style={{ background: "rgba(240, 248, 255, 0.7)" }}>
                  ...
                  <small className="text-muted d-none d-md-block">Per meeting</small>
                </div>
              </div>
              ...
              <div className="col-6 col-md-3 mb-2 mb-md-3">
                <div className="p-2 p-md-3 rounded" style={{ background: "rgba(240, 248, 255, 0.7)" }}>
                  ...
                  <small className="text-muted d-none d-md-block">Today's usage</small>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row g-2 g-md-3 g-lg-4">
          {floorHeaders.map((floor, colIdx) => (
            <div key={colIdx} className="col-12 col-sm-6 col-xl-3">
              <div className="card h-100 shadow-sm" style={{ borderRadius: "16px", background: "rgba(255,255,255,0.5)" }}>
                <div
